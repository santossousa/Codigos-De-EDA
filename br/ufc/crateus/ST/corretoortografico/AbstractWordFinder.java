...
public String toString() {
   ...
   * currentWord.
   * @param currentWord2 the wd parameter is not presently used.
   */
  protected void setSentenceIterator(Words currentWord2) {
...
//  }
   ...
   */
  private void setup() {
    currentWord = new Words("", 0);
    nextWord = new Words("", 0);
    startsSentence = true;
