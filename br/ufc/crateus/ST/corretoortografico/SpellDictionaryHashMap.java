...
public boolean addWord(String word) {
   ...
   * @param word The word to add
   */
  private Integer tamanhhoHash(Integer code) {
	  for(Integer i = 0;i < mainDictionary.size();i++) {
		  code++;
  ...
  public void imprimeDicio(){
	  for(String k : mainDictionary.keySet()) {
		  System.out.println(k+","+mainDictionary.get(k));
	  }
