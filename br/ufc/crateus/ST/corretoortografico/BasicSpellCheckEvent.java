...
class BasicSpellCheckEvent implements SpellCheckEvent {
  ...
  private List<Words> suggestions;
  /**The misspelt word*/
   ...
   * event to fire.
   */
  public BasicSpellCheckEvent(String invalidWord, List<Words> suggestions, WordTokenizer tokenizer) {
   ...
   */
  @Override
public List<Words> getSuggestions() {
    return suggestions;
  }
